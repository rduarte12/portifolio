    ...
    <main className="container" style={{ marginTop: '40px', marginBottom: '60px' }}>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p className="text-muted" style={{ marginTop: '8px' }}>
          A collection of my projects and work in the field of Data Science, Machine Learning, and Software Engineering.
        </p>
      </section>
      ...
      <section className="flex-col gap-sm">
        {(() => {
          ...
          return (
            <>
              {filteredCount === 0 ? (
                <p className="text-muted" style={{ fontSize: '0.9rem' }}>No projects found for the selected tag.</p>
              ) : (
